  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-brand-dark/80 border-r border-brand-border/40 backdrop-blur-xl z-40 flex flex-col">
      ...
      <div className="flex items-center gap-3 px-6 py-6 border-b border-brand-border/30">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-primary to-brand-accent flex items-center justify-center shadow-lg glow-primary">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 group ${
                isActive
                  ? 'bg-brand-primary/10 text-brand-primary border border-brand-primary/20 glow-primary'
